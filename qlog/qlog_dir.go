...
func DefaultTracerWithLabel(label string) func(_ context.Context, p logging.Perspective, connID logging.ConnectionID) *logging.ConnectionTracer {
	return func(_ context.Context, p logging.Perspective, connID logging.ConnectionID) *logging.ConnectionTracer {
		return qlogDirTracer(p, connID, label)
	}
}
