...
// Source: github.com/lucas-clemente/quic-go/internal/xse (interfaces: SendStream)

// Package xse is a generated GoMock package.
package xse
...
func (m *MockSendStream) PopStreamFrame(arg0 protocol.ByteCount) (*ackhandler.Frame, bool) {
	m.ctrl.T.Helper()
...
func (mr *MockSendStreamMockRecorder) PopStreamFrame(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PopStreamFrame", reflect.TypeOf((*MockSendStream)(nil).PopStreamFrame), arg0)
}
